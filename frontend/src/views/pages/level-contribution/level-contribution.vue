  ...
  <div class="height-full">
    ...
    <div class="d-flex justify-content-center">
      <input
        type="button"
        value="기여하기"
        class="btn btn-outline-primary float-right mr-3 ml-3"
        @click="submitClick()"
      >
      <input
        type="button"
        value="취소"
        class="btn btn-outline-danger float-right mr-3 ml-3"
        @click="goBack()"
      >
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    async submitClick() {
      ...
      await submit(contributionData).catch((error) => {
        console.log(error);
      });
    },
  },
