...
public class ClimbingController {
  ...
  @ApiOperation(value = "클라이밍장 solution 조회", notes = "climgingId와 level이 모두 일치하는 클라이밍장의 solution 정보를 반환합니다.")
  @ApiResponses({ @ApiResponse(code = 200, message = "성공"),
      @ApiResponse(code = 500, message = "서버 오류") })
  ...
  public ApiResponseDto<ClimbingSolutionRes> getLevelSolution(@PathVariable Long climbingId,
    ...
    ClimbingSolutionRes climbingSolutionRes = climbingService.getLevelSolution(climbingId,
        levelTierId, pageNumber);
